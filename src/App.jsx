...
const partners = ["Expedia", "Hotels.com", "CheapTickets", "Enjoy Travel", "Amadeus (teknisk)"];
    ...
    <div className="site">
      <header className="header">
        ...
        <nav>
          ...
          <a href="#partnere">Samarbeidspartnere</a>
      ...
      <main>
        ...
        <section id="partnere" className="section partners">
          <div className="sectionHeader"><p className="eyebrow">Partnere</p><h2>Samarbeidspartnere</h2></div>
          <p className="partnerText">Billig-reiser.no er klargjort for reisetilbud fra etablerte reiseaktører og affiliate-partnere.</p>
        ...
        <section id="vilkar" className="section legalGrid centerLegal">
